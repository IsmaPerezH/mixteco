<main class="historias-main" style="background-color: #f9fafb;">
    <div class="container container-historias">
        <h1 class="historias-title">Mitos y leyendas de San Miguel el Grande</h1>
...
<!-- Modal -->
<div id="modal-leyenda-1" class="modal">
    <div class="modal-content">
        <span class="close" onclick="closeModal('modal-leyenda-1')">&times;</span>
